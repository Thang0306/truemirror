  ...
  return (
    <footer className="bg-brand-navy text-white border-t border-gray-800">
      <div className="container mx-auto px-6 md:px-8 py-12 md:py-16 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-6">
          ...
          <div>
            ...
            <div className="pl-1 md:pl-2">
              <ul className="space-y-2 text-sm md:text-[15px]">
                ...
                <div className="h-1"></div>
                <li><Link to="/news" className="text-gray-300 hover:text-white transition">Thông tin</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div>
            <h4 className="font-semibold mb-4 md:mb-5 text-lg md:text-xl">Hỗ trợ</h4>
             <div className="pl-1 md:pl-2">
              <ul className="space-y-2 text-sm md:text-[15px]">
                <li><span className="text-gray-400 cursor-not-allowed">Trợ giúp</span></li>
                <div className="h-1"></div>
                <li><span className="text-gray-400 cursor-not-allowed">Bảo mật</span></li>
              </ul>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 md:mt-14 pt-7 md:pt-9 text-center text-sm md:text-base text-gray-400">
